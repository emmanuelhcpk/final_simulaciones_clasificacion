function Yest = determination_lin(SVM1,SVM2,SVM3,X,matriz)
    ...
    if(size(pos,2) == 1)
        ...
        %Hay conflicto entre clases                    
            ...
            if(vector(1) == 1 && vector(2) == 1 && vector(3) == 1)              
                ...
                distance1 = abs(sum((alfa1).*(kernel_lin(X(i,:),XSVM1))) + b1);           
                distance2 = abs(sum((alfa2).*(kernel_lin(X(i,:),XSVM2))) + b2);           
                distance3 = abs(sum((alfa3).*(kernel_lin(X(i,:),XSVM3))) + b3);           
            ...
            if(vector(1) == 1 && vector(2) == 1 && vector(3) == -1)              
                ...
                distance1 = sum((alfa1).*(kernel_lin(X(i,:),XSVM1))) + b1;           
                distance2 = sum((alfa2).*(kernel_lin(X(i,:),XSVM2))) + b2;           
                
                clases = [distance1 distance2];
            ...
            if(vector(1) == 1 && vector(2) == -1 && vector(3) == 1)              
                ...
                distance1 = sum((alfa1).*(kernel_lin(X(i,:),XSVM1))) + b1;           
                distance3 = sum((alfa3).*(kernel_lin(X(i,:),XSVM3))) + b3;           
                
                clases = [distance1 distance3];
